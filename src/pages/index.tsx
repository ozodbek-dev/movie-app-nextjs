...
import {IMovie, ProductInterface, TrendingResponse} from "@/interfaces/app.interface";
...
export const getServerSideProps: GetServerSideProps = async () => {
    const [trending, top_rated, tv_top_rated, movie_popular, documentary, comedy, history, family, products] = await Promise.all([
